...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Loading, [{
    ...
    value: function componentDidMount() {
      firebase_app__WEBPACK_IMPORTED_MODULE_10___default.a.auth().onAuthStateChanged(function (user) {
        if (user) {
          Object(_states_fn__WEBPACK_IMPORTED_MODULE_9__["default"])().login(store);
        } else {
          Router.push('/login');
        }
      });
...
//# sourceMappingURL=_app.js.e958d75c35dac9c439ef.hot-update.js.map