...
var fn = function fn(store) {
  return {
    ...
    isUserEmail: function isUserEmail() {
      var db = firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.firestore();
      db.collection('tokyoislands').doc('people').collection('users').get().then(function (doc) {
        if (doc.exist) {
...
//# sourceMappingURL=login.js.99aa57094ba504982efa.hot-update.js.map