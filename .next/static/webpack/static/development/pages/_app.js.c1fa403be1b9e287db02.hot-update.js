  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(Default, [{
    ...
    value: function componentDidMount() {
      firebase_app__WEBPACK_IMPORTED_MODULE_13___default.a.auth().onAuthStateChanged(function (user) {
        if (user) {
          console.log(Object(_states_fn__WEBPACK_IMPORTED_MODULE_19__["default"])().login()); //this.props.login()
        } else {
          Router.push('/login');
        }
      });
...
//# sourceMappingURL=_app.js.c1fa403be1b9e287db02.hot-update.js.map