...
var fn = function fn(store) {
  return {
    signOut: function signOut(store) {
      firebase_app__WEBPACK_IMPORTED_MODULE_1___default.a.auth().signOut().then(function () {}).catch(function (err) {
        console.log(err);
      });
    },
...
//# sourceMappingURL=index.js.3afb417e5ed13d5758cc.hot-update.js.map