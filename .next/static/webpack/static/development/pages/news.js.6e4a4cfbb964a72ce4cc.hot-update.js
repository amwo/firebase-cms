...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(PostEditor, [{
    ...
    value: function render() {
      ...
      console.log(c.getBlockMap()); //console.log(c.getText())
      //console.log(c.getLength())

      console.log(this.contentState.getBlockMap()); //console.log(m)
      //console.log(s)
      //console.log(k)
...
//# sourceMappingURL=news.js.6e4a4cfbb964a72ce4cc.hot-update.js.map