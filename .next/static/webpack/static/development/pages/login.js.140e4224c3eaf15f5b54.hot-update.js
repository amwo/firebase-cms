...
var fn = function fn(store) {
  return {
    ...
    isUserEmail: function isUserEmail(states, email) {
      ...
      db.collection('tokyoislands').doc('people').collection('users').where('user', '==', email).get().then(function (doc) {
        if (doc.exist) {
...
//# sourceMappingURL=login.js.140e4224c3eaf15f5b54.hot-update.js.map